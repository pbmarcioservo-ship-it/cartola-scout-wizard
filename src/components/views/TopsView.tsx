    ...
    <div className="flex gap-4">
      <div className="flex-1">
        <div className="relative bg-green-700 rounded-2xl p-4 shadow-inner">
          ...
          <div className="absolute inset-y-1/2 left-4 right-4 border-t-2 border-white/60 pointer-events-none"></div>
          <div className="absolute top-6 left-1/2 -translate-x-1/2 w-24 h-24 rounded-full border-4 border-white/70 pointer-events-none"></div>
          <div className="relative">
